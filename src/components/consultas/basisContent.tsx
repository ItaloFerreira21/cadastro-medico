export const ConsultasBasisContent = () => {
  return (
      <div className="w-[360px] h-[792px] ">
        ...
        <h3 className="pt-4 font-bold text-blue-800" >9:00
        <h4 className="pt-6 font-normal text-blue-600">Nome do medico
          <p className="font-light text-gray-500">especialidade | CRM </p>
        </h4>
        <h4 className="pt-6 font-normal text-blue-600">Nome do paciente
