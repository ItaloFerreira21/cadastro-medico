      ...
      <Drawer>
        ...
        <DrawerContent className="h-screen rounded-none">
          ...
          <DrawerFooter className=" flex w-full items-center">
            <Button className="bg-primaryBlue hover:bg-primaryBlue-dark text-white font-bold rounded-[6px] focus:outline-none focus:shadow-outline w-[90%] p-4 items-center flex justify-center py-6">Concluir cadastro</Button>
            <DrawerClose className="w-full flex justify-center">
              <Button className="bg-zinc-50 hover:bg-primaryBlue-dark text-primaryBlue border-primaryBlue border-2 font-bold rounded-[6px] focus:outline-none focus:shadow-outline w-[90%] p-4 py-6 items-center flex justify-center">Cancelar</Button>
            </DrawerClose>
          </DrawerFooter>
        </DrawerContent>
      </Drawer>
